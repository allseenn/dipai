...
##  Экологические факторы и результаты ЕГЭ в Москве.

Ссылка на диплом в формате MS Word в облаке: https://1drv.ms/w/c/fd83a0cede2c214b/EQ3O6fDw36FDmn0dGQ4RxdAB_cMcQZ8nJXqUveTMK-Q-Ew?e=pFNDeL

Документа в облаке, позволяет:

- Используя ссылку, осуществлять полное изменине документа
- Использовать примерную структуру и стили, в соотвествии с требованиям к дипломной работе
- Осуществлять совместную работу над документом
- Использовать рецензирование, для эффективных правок в совместной работе


**Основные вводные для диплома**:

    • Объем глав не превышает норматив 50 стр
    • Не увлекаться теорией
    • Использовать скриншоты с визуализациями
    • Сделать аналитику и обозначить направления прогнозирования с помощью методов МЛ или тем вашего учебного направления
    • В приложении присутствует использованный код с заголовками, чтобы был понятен ход рассуждения
    • Прикрутите куда нибудь некую технологию ИИ, обдумайте концепцию внедрения и все этапы

**Основные вводные для презентации**:

    • Так как на защите не все экзаменаторы могли видеть ваш диплом, то нужно визуализировать основные пункты дипломной, что именно было сделано, какой результат ставился и какой достигнут - нужен визуальный ряд иначе непонятно, что именно вами было сделано.
    • Сделать акцент на том, что именно ВЫ сделали, какие сложности, как вы их преодолевали, показать что проявили усилия, показать код или рабочий прототип на защите
    • Должна быть четкая цель дипломной работы, для чего она нужна. 
    • Очертить круг потребителей данного продукта, эффективность чего он повысит.
    • Для кого вы делаете данный продукт? 
    • Кто будет выгодополучателем данного продукта?
    • Где будет размещен продукт?
    • Как будет осуществлена работа в режиме предсказания? 
    • Какие есть плюсы минусы у вашего подхода? 
    • Презентация на 10-15 слайдов, где всё описано.
    • Желательно после презентации показать продукт.
    • Показать, какой то конкретный пример.
    • Показать, какой-нибудь вывод из ваших данных. Например Топ 5 или Топ -5 строк из вашей выборки, которые стали доступны, благодаря вашей работе.
...
- придумана идея расчетов расстояний от школ до факторов
- посчитан чему равен 1 км для долготы и 1 км для широты в 04.ipynb

### 20240607

- Борьба с датами и диапазонами в файле 03.ipynb
- фунция sets_intersects() проверяет пересечение дат экзаменов и экологических событий
- как итого почистил датасет ecology от событий, которые не происходили в момент прохождения ЕГЭ с 03 месяца по 09 включительно
- изменен датасет exams, т.к. в нем указан учебный год (2016/2017) но нет диапазона
- приступил к блокноту 04.ipynb и борьбе с геоданными 

### 20240606

- Работа с датами
- Причисал 02.ipynb
- Хорошо поработал над 03.ipynb

### 20240604 

 - Изменил функцию from_stroi() - получает все года
 - добавил функцию stoy_year() - заполняет пропущенные года от строищихся объектов рядом
